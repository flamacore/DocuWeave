...
class TableDialog(QDialog):
    def __init__(self, parent=None):
        ...
        row_label.setStyleSheet(scaled_css("font-size: 16px;"))
        self.rows_spin = QSpinBox()
        self.rows_spin.setMinimum(1)
        self.rows_spin.setMaximum(50)
        self.rows_spin.setValue(3)
        self.rows_spin.setStyleSheet(scaled_css("font-size: 14px; height: 35px;"))
        ...
        col_label.setStyleSheet(scaled_css("font-size: 16px;"))
        self.cols_spin = QSpinBox()
        self.cols_spin.setMinimum(1)
        self.cols_spin.setMaximum(50)
        self.cols_spin.setValue(3)
        self.cols_spin.setStyleSheet(scaled_css("font-size: 14px; height: 35px;"))
