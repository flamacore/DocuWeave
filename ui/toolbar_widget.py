...
class ToolbarWidget(QFrame):
    def __init__(self, editor_widget, parent=None):
        ...
        self.setFixedHeight(px(70))
        icon_size = QSize(px(28), px(28))
        ...
        h1_button.setIconSize(icon_size)
        ...
        h2_button.setIconSize(icon_size)
        ...
        h3_button.setIconSize(icon_size)
        ...
        normal_button.setIconSize(icon_size)
        ...
        bold_button.setIconSize(icon_size)
        ...
        italic_button.setIconSize(icon_size)
        ...
        underline_button.setIconSize(icon_size)
        ...
        strike_button.setIconSize(icon_size)
        ...
        quote_button.setIconSize(icon_size)
        ...
        bullet_list_button.setIconSize(icon_size)
        ...
        numbered_list_button.setIconSize(icon_size)
        ...
        align_left.setIconSize(icon_size)
        ...
        align_center.setIconSize(icon_size)
        ...
        align_right.setIconSize(icon_size)
        ...
        emoji_button.setIconSize(icon_size)
        ...
        link_button.setIconSize(icon_size)
        ...
        info_box_btn.setIconSize(icon_size)
        ...
        image_button.setIconSize(icon_size)
        ...
        table_button.setIconSize(icon_size)
        ...
        ai_summarize_button.setIconSize(icon_size)
    ...
    def insert_emoji(self, emoji):
        ...
        js = "document.execCommand('insertText', false, {});".format(json.dumps(emoji, ensure_ascii=False))
        self.editor_widget.web_view.page().runJavaScript(js)
